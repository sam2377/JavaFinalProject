				...
				try {
					if (br.ready()) {
						...
						if (msg.equals(Identifier.CreateAccountF)) {
							JOptionPane.showMessageDialog(LogInPage.logInPage, "Â∏≥ËôüÂ∑≤Â≠òÂú®");
						} else if (msg.equals(Identifier.CreateAccountS)) {
							JOptionPane.showMessageDialog(LogInPage.logInPage, "Â∏≥ËôüÂª∫Á´ãÊàêÂäü");
						} else if (msg.equals(Identifier.LoginFailure)) {
//							System.out.println("LoginFailure");
							JOptionPane.showMessageDialog(LogInPage.logInPage, "ÁôªÂÖ•Â§±Êïó");
						} else if (msg.equals(Identifier.LoginSuccess)) {
//							System.out.println("LoginSuccess");
							JOptionPane.showMessageDialog(LogInPage.logInPage, "ÁôªÂÖ•ÊàêÂäü");
				...
				try {
					if (br.ready()) {
						...
						if(msg.contains(Identifier.AddFriendS)) {
							JOptionPane.showMessageDialog(LogInPage.mainPage, "•[§J¶n§Õ¶®•\");
